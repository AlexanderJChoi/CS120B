...
unsigned char three_led_out, blink_led_out, b_out;
unsigned long three_led_time, blink_led_time, combo_time;
...
void combo_tick() {
	...
	switch(combo_state) {
		case write:
			PORTB = three_led_out | blink_led_out;
	}
}
